...
parameterClass::parameterClass(std::string runName) {
  ...
  radicalNames.push_back("alphaPhellandrene");
  ...
  pvSampleTimes = 5;
  pressureSmear = 180;
  pvFolder      = "/reg/ued/ana/scratch/alphaPhellandrene/PV/";
  ...
  fillLowQfile      = "/reg/neh/home5/khegazy/analysis/alphaPhellandrene/UED/timeDepStudies/results/sim-LowQfill[555].dat";
  fillLowQtheory    = true;
  ...
  elEnergy        = 3.7e6;
  screenDist      = 4;
  xyzDir          = "/reg/neh/home/khegazy/analysis/alphaPhellandrene/simulation/XYZfiles/";
  simOutputDir    = "/reg/ued/ana/scratch/alphaPhellandrene/simulations/";
  fsFitOffset     = false;
  fsFilterSMS     = false; 
  ...
  preProcOutputDir    = "/reg/ued/ana/scratch/alphaPhellandrene/rootFiles/";
  mergeScansOutputDir = "/reg/ued/ana/scratch/alphaPhellandrene/mergeScans/";
  scanSearchOutputDir = "/reg/ued/ana/scratch/alphaPhellandrene/scanSearch/";
  radialPixelDist     = "/reg/ued/ana/scratch/alphaPhellandrene/radialPixelDist/";
  backgroundImage     = "NULL";
  backgroundFolder    = "/reg/ued/ana/scratch/alphaPhellandrene/background/";
  ...
  if (runName.compare("20180725_0127") == 0) {
    ...
    // Bad scans
    badScans.push_back(14);
    badScans.push_back(15);
    badScans.push_back(52);
    badScans.push_back(53);
    badScans.push_back(60);
    for (int i=64; i<=70; i++) {
    ...
    // Background
    backgroundImage = "backgroundImg-20180725_0115.dat";
    hasLaserBkg = true;
    ...
    // PV files / variables
    pvMap["pressure"]    = "pressureSampleChamber_07_25_2018_01_27_40-07_26_2018_01_47_00-17514.dat";
    pvMap["UVcounts"]    = "UVsampleChamberCam_07_25_2018_01_27_40-07_26_2018_01_47_00-17514.dat";
    ...
    switch (molecule) {
      case initialState: {
        xyzFiles.push_back("170904_alpha-phellandrene_opt.xyz");
        break;
      }
      default: {
